...
=== {ltrace}
  ...
  \item With the `-S` option it shows system calls too!
  \item Also offers a summary with its `-c` option.
  \item Manual page: \url{https://linux.die.net/man/1/ltrace}
  \item Works better with {\em glibc}. `ltrace` used to be broken
