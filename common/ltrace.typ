...
===  ltrace A tool to trace #strong[shared] library calls used by a
...
- Works better with #emph[glibc]. `ltrace` used to be broken with
  #emph[uClibc] (now fixed), and is not supported with #emph[Musl]
