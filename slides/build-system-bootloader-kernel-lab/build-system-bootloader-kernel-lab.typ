...
#setuplabframe([Build and boot the system],[ Compile your system
components and get your system up and running#v(0.3em)

- Compile the root filesystem with Buildroot#v(0.3em)

- Compile, install and run the bootloader (U-Boot)#v(0.3em)

- Compile and install the Linux kernel#v(0.3em)
