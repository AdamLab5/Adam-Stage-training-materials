...
=== Evaluation and final quiz
  ...
  \item Fill in the final quiz to assess your level of knowledge on
    the topics covered in this course. To get the training
    certificate, you must have attended all sessions, and get at least
    50\% of correct answers at this final quiz:
    ...
    The training certificate is sent two weeks after the training
    end's date.
