...
===  Amplifier What about the amplifier?

- Supported using #emph[auxiliary devices]
...
#kfile("sound/soc/samsung/neo1973_wm8753.c")
...
- This exposes routes between `Mic Mux IN1` and `Mic Mux IN2` to `Mic
  Mux OUT`.
...
#kfile("arch/arm64/boot/dts/freescale/imx8mq-librem5-devkit.dts")
