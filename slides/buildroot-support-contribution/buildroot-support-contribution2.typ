...
- Free support
  ...
  - The #emph[mailing list] for e-mail discussion 
...
- If you have a build issue to report:
 ...
 - Include the Buildroot version, Buildroot ``` .config ``` that
    reproduces the issue, and last 100-200 lines of the build output in
    your report.
...
#align(center, [#image("patchwork.png", height: 50%)])
