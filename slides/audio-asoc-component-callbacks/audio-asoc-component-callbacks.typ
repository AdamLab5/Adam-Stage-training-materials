...
- Available formats are:
  ...
  - #ksym("SND_SOC_DAIFMT_I2S")

  - #ksym("SND_SOC_DAIFMT_RIGHT_J")

  - #ksym("SND_SOC_DAIFMT_LEFT_J")

  - #ksym("SND_SOC_DAIFMT_DSP_A")

  - #ksym("SND_SOC_DAIFMT_DSP_B")

  - #ksym("SND_SOC_DAIFMT_AC97")

  - #ksym("SND_SOC_DAIFMT_PDM")

- Also the polarity can be changed:

  - #ksym("SND_SOC_DAIFMT_NB_NF"): normal bit clock + normal
    frame

  - #ksym("SND_SOC_DAIFMT_NB_IF"): normal bit clock + invert
    frame

  - #ksym("SND_SOC_DAIFMT_IB_NF"): invert bit clock + normal
    frame
