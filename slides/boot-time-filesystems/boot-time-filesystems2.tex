...
=== Filesystem impact on performance Tuning the filesystem is usually one of the first things we work on in boot time projects.
\begin{itemize}
...
\item Boot your system at least once with the
      `ubi.fm_autoconvert=1` kernel parameter.
\item Reboot your system in a clean way
\item You can now remove `ubi.fm_autoconvert=1`
\end{itemize}
