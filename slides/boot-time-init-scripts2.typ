...
===  Initramfs An idea is to use a very small initramfs, just enough
to start the critical application and then switch to the final root
filesystem.

#align(center, [#image("boot-time-initramfs-principle.pdf", width: 100%)])
