...
- In UNIX systems, applications and users see a #strong[single global
  hierarchy] of files and directories, which can be composed of several
  filesystems.

- Filesystems are #strong[mounted] in a specific location in this
  hierarchy of directories

  - When a filesystem is mounted in a directory (called #emph[mount
    point]), the contents of this directory reflect the contents of this
    filesystem.

  - When the filesystem is unmounted, the #emph[mount point] is empty
    again.
...
- This filesystem is called the #strong[root filesystem]
...
- The kernel must be compiled with
  ...
  - #kconfigval("CONFIG_NFS_FS", "y") (NFS #strong[client]
    support)
